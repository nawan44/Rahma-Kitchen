...
class PaketpaketBento extends React.Component {
    render() {
        return (
            // <div>
            //     <h1>Paket paketBento</h1>

            // </div>
            <Container>
                <p><h1>Paket paketBento</h1></p> <br />

                <p><h3 className="paketh3">Paket 1</h3>
                    <Row>
                        <Col xs="6"><img src={bento1} className="paketBentoImg" /></Col>
                        <Col xs="6">
                            <ol>
                ...
                <p>
                    ...
                    <Row>
                        <Col xs="6"><img src={bento2} className="paketBentoImg" /></Col>
                        <Col xs="6">
                            <ol>
                                <li className="liprod">Nasi</li>
                                <li className="liprod">Ayam Sayur</li>
                ...
                <p>
                    ...
                    <Row>
                        <Col xs="6"><img src={bento3} className="paketBentoImg" /></Col>
                        <Col xs="6">
                            <ol>
                                <li className="liprod">Nasi</li>
                                <li className="liprod">Ayam Sayur</li>
                ...
                <p>
                    ...
                    <Row>
                        <Col xs="6"><img src={bento4} className="paketBentoImg" /></Col>
                        <Col xs="6">
                            <ol>
                                <li className="liprod">Nasi</li>
                                <li className="liprod">Ayam Sayur</li>
                ...
                <p>
                    ...
                    <Row>
                        <Col xs="6"><img src={bento5} className="paketBentoImg" /></Col>
                        <Col xs="6">
                            <ol>
                                <li className="liprod">Nasi</li>
                                <li className="liprod">Ayam Sayur</li>
                ...
                <p>
                    ...
                    <Row>
                        <Col xs="6"><img src={bento6} className="paketBentoImg" /></Col>
                        <Col xs="6">
                            <ol>
                                <li className="liprod">Nasi</li>
                                <li className="liprod">Ayam Sayur</li>
...
export default PaketpaketBento